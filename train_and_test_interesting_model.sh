...
do
    ...
    then
        ...
        matlab -nosplash -r "addpath('$MATLAB_LIBPATH'); batchDetection('$TRAIN_POSITIVE_FEATURE', '$TRAIN_NEGATIVE_FEATURE', '$TEST_POSITIVE_FEATURE', '$TEST_NEGATIVE_FEATURE', '$MODELPATH', 'model', 1, -1)"
